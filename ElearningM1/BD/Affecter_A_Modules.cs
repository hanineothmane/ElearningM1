...
namespace ElearningM1.Models
{
    public static class Affecter_A_Modules
    {
        ...
        public static List<Affecter_A_Module> getAffectations(Module m)
        {
            string select = "select \"Affecter_A_Module\".note_final, \"Module\".id_module, \"Apprenant\".id_apprenant from \"Apprenant\", \"Module\", \"Affecter_A_Module\" where \"Apprenant\".id_apprenant = \"Affecter_A_Module\".id_apprenant and \"Affecter_A_Module\".id_module = \"Module\".id_module and \"Affecter_A_Module\".id_module = " + m.Id + "";
            return BDD.Execute(select).AsEnumerable().Select(row =>
                new Affecter_A_Module()
                {
                    NoteFinale = row.Field<Nullable<double>>("note_final"),
